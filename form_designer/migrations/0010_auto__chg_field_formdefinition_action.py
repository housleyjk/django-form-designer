...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FormDefinition.action'
        db.alter_column(u'form_designer_formdefinition', 'action', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'FormDefinition.action'
        db.alter_column(u'form_designer_formdefinition', 'action', self.gf('django.db.models.fields.URLField')(max_length=255, null=True))
